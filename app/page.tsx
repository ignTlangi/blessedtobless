    ...
    <main className={styles.main}>
      ...
      <section id="founders" className={styles.founders}>
        <div className={styles.sectionContainer}>
          ...
          <p className={styles.sectionSub}>Three young leaders from different walks of life, united by faith and a shared conviction that their generation can be a force for good. Together, they turned a vision into a movement.</p>
          <div className={styles.founderGrid}>
            {[
              { name: 'Neo Kobe', initials: 'NK', role: 'Co-Founder', bio: 'Visionary leader and driving force behind the foundation\'s operations and community partnerships.', image: '/images/founder-neo.jpg', linkedin: 'https://www.linkedin.com/in/neo-kobe-818010246/' },
              { name: 'Mahlatse Mokoena', initials: 'MM', role: 'Co-Founder', bio: 'Passionate advocate for child welfare, leading outreach initiatives and volunteer coordination.', image: '/images/founder-mahlatse.jpg', linkedin: 'https://www.linkedin.com/in/mahlatse-mokoena-27565b295/' },
              { name: 'Khutso Mtsweni', initials: 'KM', role: 'Co-Founder', bio: 'Creative strategist behind the foundation\'s brand, communications, and youth engagement programs.', image: '/images/founder-khutso.jpg', linkedin: 'https://www.linkedin.com/in/khutso-mtsweni-418b15345/' },
            ].map((f) => (
      ...
      <section className={styles.impactSection}>
        <div className={styles.sectionContainer}>
          <div className={styles.impactQuote}>
            ...
            <p className={styles.impactEmail}><a href="mailto:blessedtoblessf@gmail.com" className={styles.impactEmailLink}><EmailIcon /> blessedtoblessf@gmail.com</a></p>
          </div>
        </div>
      </section>
      ...
      <footer id="contact" className={styles.footer}>
        <div className={styles.sectionContainer}>
          ...
          <div className={styles.footerBottom}>
            ...
            <a href="https://www.linkedin.com/in/tlangi/" target="_blank" rel="noopener noreferrer" className={styles.footerCredit}>Website developed by Tlangelani Khosa</a>
          </div>
        </div>
      </footer>
